...
>
	<div class="flex relative">
		...
		<div class="flex items-center gap-2">
			...
			<h3 class="text-l sm:text-xl md:text-2xl">{reviewItem.name}</h3>
		</div>
	</div>
  ...
  <div class="flex items-center flex-wrap gap-2 text-xs sm:text-sm mb-4">
    ...
    <div class="p-1 py-0.5 rounded-md border border-solid border-indigo-400 bg-indigo-50 text-indigo-400"><p>{keyword}</p></div>
    {/each}</div>
